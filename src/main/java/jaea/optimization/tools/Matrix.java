...
public class Matrix {
	 ...
	 *            Number of columns
	 * @param code
	 *            Initialize matrix with 0's, 1's or diagonal
	 */
	...
	/**
	 * Constructor as matrix 'wrapper' for double [][] 2D array (copy by
	 * reference)
	 */
	 ...
	 *            Destination matrix
	 * @param destInd
	 *            Row indices of destination matrix
	 * @param srcMat
	 *            Source matrix
	 * @param srcInd
	 *            Row indices of source matrix to be copied from
	 */
	public static void copyRows(Matrix destMat, int[] destInd, Matrix srcMat,
			int[] srcInd) {
		...
		for (int n = 0; n < nRows; n++) {
			for (int c = 0; c < srcMat.col; c++)
				destMat.mat[destInd[n]][c] = srcMat.mat[srcInd[n]][c];
		}
	}
	 ...
	 *            Destination matrix
	 * @param destInd
	 *            Column indices of destination matrix
	 * @param srcMat
	 *            Source matrix
	 * @param srcInd
	 *            Column indices of source matrix
	 */
	public static void copyCols(Matrix destMat, int[] destInd, Matrix srcMat,
			int[] srcInd) {
		if (srcInd.length != destInd.length) {
			System.err.println("Index mismatched...");
			return;
		...
		for (int n = 0; n < nCols; n++) {
			for (int r = 0; r < srcMat.row; r++)
				destMat.mat[r][destInd[n]] = srcMat.mat[r][srcInd[n]];
		}
	}
