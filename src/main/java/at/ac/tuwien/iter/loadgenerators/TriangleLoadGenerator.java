...
public class TriangleLoadGenerator implements LoadGenerator {
	...
	public static final String PERIOD_LB = "at.ac.tuwien.loadgenerator.triangle.period.lb";
	public static final String PERIOD_UB = "at.ac.tuwien.loadgenerator.triangle.period.ub";
	...
	public double[] getLowerBounds() {
		return new double[] { amplitudeBounds[0], periodBounds[0] };
	}

	public double[] getUpperBounds() {
		return new double[] { amplitudeBounds[1], periodBounds[1] };
	}
	...
	public Test generateRandomCase() {
		...
		// Consider up to 2 digit after . for step !
				randomInRange(random, amplitudeBounds[0], amplitudeBounds[1], 2),
